<template>
     <div>
        <h2 class="text-grey text-h3  text-center">show details</h2>
        <div class="thebox">
         <div class="image">
         <v-img
      ...
      >
        ...
        <template  v-slot:default="{ isActive }">
          <v-card class="thevideoo" style="width: 90vw; height:100vh;">
            ...
            ></v-toolbar>
            <v-card-text>
              <h2 >there's no video available</h2>
            </v-card-text>
            <v-card-actions class="justify-end">
              <v-btn
                variant="text"
      ...
      >
        ...
        <h2 class="text-grey text-center text-h3 my-7">cast</h2>
        <div class="thecast">
...
export default {
    ...
    let mainurl = ref('https://api.themoviedb.org/3/');
        ...
        const getTheMovie = async () => {
            let result = await axios.get(`${mainurl.value}/tv/${props.id}?${apiKey.value}&append_to_response=videos%2Cimages%2Ccredits`);
